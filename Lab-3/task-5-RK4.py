...
def next_x(t, x, z):
    ...
    k3 = ((x * k2/2 + T * get_linear_velocity(t + T/2) * np.cos(z)) - x * k2/2)
    k4 = ((x * k3 + T * get_linear_velocity(t + T) * np.cos(z)) - x * k3)
    return x + 1/6 * (k1 + 2 * k2 + 2 * k3 + k4)

def next_y(t, y, z):
    k1 = ((y + T * get_linear_velocity(t) * np.sin(z)) - y)
    k2 = ((y * k1/2 + T * get_linear_velocity(t + T/2) * np.sin(z)) - y * k1/2)
    k3 = ((y * k2/2 + T * get_linear_velocity(t + T/2) * np.sin(z)) - y * k2/2)
    k4 = ((y * k3 + T * get_linear_velocity(t + T) * np.sin(z)) - y * k3)
    return y + 1/6 * (k1 + 2 * k2 + 2 * k3 + k4)

def next_z(t, z):
    k1 = ((z + T * get_circular_velocity(t)) - z)
    k2 = ((z * k1/2 + T * get_circular_velocity(t)) - z * k1/2)
    k3 = ((z * k2/2 + T * get_circular_velocity(t)) - z * k2/2)
    k4 = ((z * k3 + T * get_circular_velocity(t)) - z * k3)
